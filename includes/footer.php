  ...
  <div class="row align-items-center justify-content-lg-between">
    <div class="col-lg-6">
      <div class="copyright text-center  text-lg-left  text-muted">
        &copy; 2023 <a href="https://hou.edu.vn" class="font-weight-bold ml-1" target="_blank">HOU</a>
      </div>
    </div>
    <div class="col-lg-6">
      <ul class="nav nav-footer justify-content-center justify-content-lg-end">
        <li class="nav-item">
          <a href="https://www.facebook.com/HOUNews" class="nav-link" target="_blank">Facebook</a>
        </li>
        <li class="nav-item">
          <a href="https://hou.edu.vn" class="nav-link" target="_blank">Discord</a>
        </li>
      </ul>
    </div>
  </div>
