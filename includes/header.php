...
<script src="<?= $duogxaolin->home_url() ?>/src/dashboard/assets/vendor/jquery/dist/jquery.min.js"></script>
      <!-- summernote -->
      <link rel="stylesheet" href="<?=$duogxaolin->home_url();?>/admin/plugins/summernote/summernote-bs4.css">
    <!-- Summernote -->
    <script src="<?=$duogxaolin->home_url();?>/admin/plugins/summernote/summernote-bs4.min.js"></script>
</head>
    <style>
        .async-hide {
            opacity: 0 !important
