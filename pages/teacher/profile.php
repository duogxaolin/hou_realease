            ...
            <div class="card card-profile"><img src="https://hou.edu.vn/files/photos/4/banner_website_3.jpg" alt="Image placeholder" class="card-img-top">
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col">
                            <div class="card-profile-stats d-flex justify-content-center">
                                <div><span class="heading"><?=format_cash($duogxaolin->num_rows("SELECT * FROM `class` WHERE `leader`  = '".$auth['username']."'    "));?></span> <span class="description">Lớp quản lý</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300"><i class="ni location_pin mr-2"></i> Tên đăng nhập:<?=$auth['username']?></div>
                ...
                <div class="col-lg-6">
                    <div class="card bg-gradient-info border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0 text-white">Lớp quản lý</h5>   <span class="h2 font-weight-bold mb-0 text-white"><?=format_cash($duogxaolin->num_rows("SELECT * FROM `class` WHERE `leader`  = '".$auth['username']."'    "));?></span>
                                </div>
                                <div class="col-auto">
                    ...
                    <form>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email">Tên đăng nhập</label>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-country">Ngày bắt đầu</label>
