                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="input-group input-group-merge shadow-none">
                                    ...
                                    <input name="tukhoa" type="text" class="search form-control border-0 form-control-flush shadow-none pb-2"
                                        placeholder="Nhập dữ liệu: tên vấn đề,..." />
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card bg-white border-light shadow-soft p-4 rounded">
                            ...
                            <div class="card-body p-0 pt-4">
                                <strong class="mb-0">Richard Thomas was born in 1990, and at only 29 years old, his trajectory is good. When he is asked how he describes himself, he responds, "designer but in a broad sense". His projects?</strong>
                            </div>
                        </div>
                    </div>
