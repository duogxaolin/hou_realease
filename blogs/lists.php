...
$locs = check_string($_GET['select']);
if(isset($_GET['select']) and $locs != ''){
$finds = "WHERE  `content` LIKE '%$locs%' or
              `title` LIKE '%$locs%'  ORDER BY id DESC";
}else{
    header("Location: ".$duogxaolin->home_url()."/helper/1");
}
?>
<!--
//////////////////////////////////////////////////////////////////////
    ...
    <main>
        ...
        <section class="section section-lg line-bottom-light">
            <div class="container mt-n7 mt-lg-n12 z-2">
                ...
                <?php  
                 foreach ($duogxaolin->get_list(" SELECT * FROM `blogs` $finds ") as $row) { ?>
