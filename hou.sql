...
INSERT INTO `score` (`id`, `username`, `tinchi`, `amount`, `name_subject`, `id_subject`, `score1`, `score2`, `score3`, `score4`, `mark`, `status`, `date`, `note`) VALUES
(1, '21a120100061', 3, 1, 'Lập trình hướng đối tượng', 'LTHDT_DT', 10, 10, 9.8, 9.86, 'A+', 1, '2023-03-07 10:10:12', 'Cần học ít hơn'),
(2, '21a120100061', 3, 1, 'Đại số', 'DS_DT', 10, 9.5, 9.8, 9.76, 'A+', 1, '2023-03-07 10:10:12', 'Cần học ít hơn!!'),
(3, '21a120100061', 3, 1, 'Kỹ thuật điện', 'KTD_DT', 10, 9.5, 9.8, 9.76, 'A+', 1, '2023-03-07 10:10:12', 'Cần học ít hơn!!');
